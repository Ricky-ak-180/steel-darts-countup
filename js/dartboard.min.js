...
var _dbUIMode    = 'board';  // 'board' | 'kz' | 'sz'
...
try { var _um = localStorage.getItem('db_ui_mode'); if (_um === 'board' || _um === 'kz' || _um === 'sz') _dbUIMode = _um; } catch(e) {}
...
function _dbSetUIMode(mode) {
  ...
  var szBtn    = document.getElementById('db-mode-sz');
  ...
  if (szBtn)    szBtn.classList.toggle('db-mode-on',    mode === 'sz');
