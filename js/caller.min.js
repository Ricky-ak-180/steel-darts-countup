...
function _callerInitAudio() {
  ...
  fetch(_callerAudioBase + 'manifest.json')
    ...
    .then(function(m) {
      _callerMode = 'audio'; _callerManifestReady = true;
    ...
    .catch(function() {
      if (_callerAudioBase === _callerAudioBaseF) {
        ...
        fetch(_callerAudioBase + 'manifest.json')
          .then(function(r) { return r.ok ? r.json() : Promise.reject(); })
          .then(function() { _callerMode = 'audio'; _callerManifestReady = true; _callerInitSpeech(); })
          .catch(function() { _callerMode = 'speech'; _callerInitSpeech(); });
      } else {
        _callerMode = 'speech';
...
function toggleCallerGender() {
  ...
  _callerCache = {}; _callerQueue = []; _callerPlaying = false;
